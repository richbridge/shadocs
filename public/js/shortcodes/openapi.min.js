import{addFunctionToResizeEvent,getFirstAncestorByClass,}from"../theme/modules/helpers.min.js";window.noZensmooth=!0,document.addEventListener("DOMContentLoaded",function(){renderAllOpenAPI()});function renderAllOpenAPI(){let e=document.getElementsByClassName("sc-openapi-container");for(let t=0;t<e.length;t++)renderOpenAPI(e[t]);if(e.length){const e=function(){let e=document.getElementsByClassName("sc-openapi-iframe");for(let t=0;t<e.length;t++)setOpenAPIHeight(e[t])};addFunctionToResizeEvent(e)}}function renderOpenAPI(e){const n=e.id,s=n+"-error",o=document.getElementById(s);o&&o.remove();const t=document.createElement("iframe"),a=new URL("css/external/swagger-ui/swagger-ui.min.css",baseUrl).href,r="stylesheet",i="text/css",c="html,body { overflow: hidden; }";t.classList.toggle("sc-openapi-iframe",!0),t.srcdoc=`
    <html>
      <head>
